...
export function ServiceHealthCard() {
  return (
    <Card className="w-[373px] shrink-0 h-full rounded-[12px] flex flex-col gap-0 justify-start items-start">
      ...
      <div className="box-border w-fit [flex:1_1_0] flex flex-col gap-[24px] p-[16px] justify-between items-start">
        <div className="box-border w-[335.664px] h-fit shrink-0">
        ...
        <div className="box-border w-full h-fit shrink-0 flex flex-col gap-0 p-[12px] justify-start items-start bg-[#f8fafcff] border border-[#e2e8f0] rounded-[12px]">
          <p className="text-[14px]/[20px] box-border w-[310px] text-[#334155ff] font-normal text-left">
