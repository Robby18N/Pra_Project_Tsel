...
export function ServiceHealthCard() {
  return (
    <Card className="flex-1 min-w-0 h-full rounded-[12px] flex flex-col gap-0 justify-start items-start">
      ...
      <div className="box-border w-full [flex:1_1_0] flex flex-col gap-[14px] p-[14px_16px_16px_16px] justify-start items-start">
        <div className="box-border w-full h-fit shrink-0">
          <ServiceHealthProgress />
        </div>
        <div className="box-border w-full h-fit shrink-0 flex flex-col gap-0 p-[10px_12px] justify-start items-start bg-[#f8fafcff] border border-[#e2e8f0] rounded-[12px]">
