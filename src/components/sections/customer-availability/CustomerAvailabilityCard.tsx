...
export function CustomerAvailabilityCard() {
  return (
    <Card className="w-[371px] shrink-0 h-full rounded-[12px] flex flex-col gap-0 justify-start items-start">
      ...
      <div className="box-border w-full [flex:1_1_0] flex flex-col gap-[20px] p-[16px] justify-start items-start">
        {CUSTOMER_AVAILABILITY.map((row) => (
          <div key={row.name} className="box-border w-full h-fit shrink-0 flex flex-col gap-[6px] justify-start items-start">
            <div className="box-border w-full h-[20px] shrink-0 flex flex-row justify-between items-center">
