...
export function TrendCard({ label, dotColor, value, trend, trendBgClassName, trendTextClassName, color, data }: TrendDatum) {
  return (
    <Card className="[flex:1_1_0] h-fit rounded-[12px] flex flex-col gap-[12px] p-[16px] justify-start items-start">
      <div className="box-border w-full h-fit shrink-0 flex flex-col gap-[12px] justify-start items-start">
        ...
        <div className="text-[32px]/[36px] box-border text-[#020617ff] font-bold text-left whitespace-nowrap">
          {value}
        </div>
      </div>
      <div className="box-border w-full h-fit shrink-0 flex flex-col gap-[8px] justify-start items-center">
        <SparklineChart data={data} labels={TREND_X_LABELS} color={color} height={90} />
