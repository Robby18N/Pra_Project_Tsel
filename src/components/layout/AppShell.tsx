 ...
 * offsets the scrollable content past the 289px sidebar rail, and renders
 * the sidebar itself. Keeping this here means `page.tsx` only has to list
 * *what* goes on the page, not *how* the shell is put together.
 */
