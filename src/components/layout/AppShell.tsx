 ...
 * lays the sidebar and scrollable content side by side as flex siblings so
 * the sidebar can stay pinned (sticky) while the content scrolls. Owns the
 * collapsed/expanded state so the sidebar's own width. Which page is
  ...
  return (
    <div className="min-h-screen overflow-x-auto bg-[#f1f5f9] flex justify-center">
      <div className="box-border w-full max-w-[1470px] min-w-[1200px] h-fit shrink-0 relative flex flex-row gap-0 justify-start items-stretch bg-[#f1f5f9]">
        ...
        />
        <div className="relative z-[1] box-border min-w-0 flex-1 h-fit shrink-0 flex flex-col gap-0 justify-start items-start">
          {children}
        </div>
      </div>
    </div>
